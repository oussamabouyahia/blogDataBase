...
describe("Blog Server with Database Interaction", () => {
  ...
  describe("Should output all posts from the DB", () => {
    ...
    it("it should GET all records stored in the database table", (done) => {
      ...
      let queryString = `INSERT INTO posts ("idposts", "title" ,"body","users_iduser"  ) VALUES ("2", "second title" ,"2nd body" ,"1");
      INSERT INTO posts ( "idposts", "title" ,"body","users_iduser" ) VALUES ("3", "3rd title" ,"3rd body" ,"1");
      INSERT INTO posts ("idposts", "title" ,"body","users_iduser" ) VALUES ("4", "fourth title" ,"4 body" ,"1");`;

      //TODO - provide example values matching respective field types
      let queryArgs = [["2", "second title" ,"2nd body" ,"1"], ["3", "3rd title" ,"3rd body" ,"1"], ["4", "fourth title" ,"4 body" ,"1"]];
        ...
        chai
          ...
          .end((err, res) => {
            ...
            res.body.forEach((element) => {
              ...
              element.should.have.property("title").that.is.oneOf(["3rd title", "second title", "fourth title"]);
            });
            done();
          });
      });
